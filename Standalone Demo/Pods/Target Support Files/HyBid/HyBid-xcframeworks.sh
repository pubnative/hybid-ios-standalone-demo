...
install_xcframework "${PODS_ROOT}/HyBid/PubnativeLite/PubnativeLite/OMSDK-1.3.22/OMSDK-Static_Pubnativenet.xcframework" "HyBid/Core" "library" "ios-arm64_i386_x86_64-simulator" "ios-arm64_armv7"
