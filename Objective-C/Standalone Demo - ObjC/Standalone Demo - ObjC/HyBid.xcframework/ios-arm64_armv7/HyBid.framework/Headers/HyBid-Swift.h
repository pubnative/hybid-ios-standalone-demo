...
- (nonnull instancetype)initWith:(NSString * _Nonnull)eventType adFormat:(NSString * _Nullable)adFormat properties:(NSDictionary<NSString *, NSString *> * _Nullable)properties OBJC_DESIGNATED_INITIALIZER;
...
@property (nonatomic) BOOL isMediation;
@property (nonatomic) BOOL isAutoCacheOnLoad;
- (nonnull instancetype)initWithZoneID:(NSString * _Nonnull)zoneID andWithDelegate:(id <HyBidRewardedAdDelegate> _Nonnull)delegate;
- (nonnull instancetype)initWithZoneID:(NSString * _Nonnull)zoneID withAppToken:(NSString * _Nullable)appToken andWithDelegate:(id <HyBidRewardedAdDelegate> _Nonnull)delegate;
- (void)load;
- (void)prepare;
- (void)setMediationVendor:(NSString * _Nonnull)mediationVendor;
- (void)prepareAdWithContent:(NSString * _Nonnull)adContent;
...
@property (nonatomic, strong) NSNumber * _Nullable videoSkipOffset;
@property (nonatomic, strong) NSNumber * _Nullable htmlSkipOffset;
@property (nonatomic, strong) NSNumber * _Nullable endCardCloseOffset;
